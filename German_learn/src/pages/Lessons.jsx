...
function Lessons() {
  ...
  return (
    <>
      <div className="mx-auto font-sans bg-[#fbf8ff] pt-10  gap-4 md:p-10">
        <img
          src="/images/main.png"
          className="w-36 mx-auto mb-4"
          alt="German language learning interface with colorful vocabulary cards and lesson navigation"
        />
        <h1 className="md:text-7xl text-4xl pb-4 text-center  text-black font-bold">The <span className="text-green-600 font-rouge">German</span> Project</h1>
...
<div>
  ...
  <p>Fairy tales in German with English translations and slow, clear audio from a native German speaker.</p>
   ...
   <Link to='/'>  Read Stories </Link>  </button> 
</div>
...
<div>
  ...
  <p>Fairy tales in German with English translations and slow, clear audio from a native German speaker.</p>
   <button className="bg-blue-500 text-white px-4 py-2 rounded mt-2">
  <Link to='/story'>  Read Stories </Link>  </button> 
</div>
<div>
  <h1 className="text-green-600 text-xl mb-2 ">German Children's Stories</h1>
  <p>Fairy tales in German with English translations and slow, clear audio from a native German speaker.</p>
   <button className="bg-blue-500 text-white px-4 py-2 rounded mt-2">
    <Link to='/review'> Read Stories</Link> </button> 
</div>
...
<div className="text-white bg-[#4a4951] lg:flex justify-center px-10  md:px-64   gap-4 mt-6">
